...
namespace LearnProject.Models.ViewModels
{
    public class UserView
    {
        ...
        [Required(ErrorMessage = "UV. Введите email")]
        [ValidEmail(ErrorMessage = "UV. Введите корректный email")]
        public string Email { get; set; }

        [Required(ErrorMessage = "UV. Введите пароль")]
        public string Password { get; set; }

        [System.ComponentModel.DataAnnotations.Compare("Password", ErrorMessage = "UV. Пароли должны совпадать")]
